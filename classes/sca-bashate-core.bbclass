...
python do_sca_bashate_core() {
    import os
    import subprocess
    d.setVar("SCA_EXTRA_SUPPRESS", d.getVar("SCA_BASHATE_EXTRA_SUPPRESS", True))
    d.setVar("SCA_EXTRA_FATAL", d.getVar("SCA_BASHATE_EXTRA_FATAL", True))
    ...
    ## Create data model
    d.setVar("SCA_DATAMODEL_STORAGE", "{}/bashate.dm".format(d.getVar("T", True)))
