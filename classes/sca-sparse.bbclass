...
python do_sca_sparse() {
    import os
    import subprocess
    d.setVar("SCA_EXTRA_SUPPRESS", d.getVar("SCA_SPARSE_EXTRA_SUPPRESS", True))
    d.setVar("SCA_EXTRA_FATAL", d.getVar("SCA_SPARSE_EXTRA_FATAL", True))
    d.setVar("SCA_SUPRESS_FILE", os.path.join(d.getVar("STAGING_DATADIR_NATIVE", True), "sparse-{}-suppress".format(d.getVar("SCA_MODE", True))))
    d.setVar("SCA_FATAL_FILE", os.path.join(d.getVar("STAGING_DATADIR_NATIVE", True), "sparse-{}-fatal".format(d.getVar("SCA_MODE", True))))

    _args = ["sparse"]
    _args += ["-gcc-base-dir", os.path.join(d.getVar("STAGING_DIR", True), d.getVar("prefix", True))]
    ...
    ## Create data model
    d.setVar("SCA_DATAMODEL_STORAGE", "{}/sparse.dm".format(d.getVar("T", True)))
