...
python do_sca_phpsecaudit() {
    ...
    cmd_output = exec_wrap_check_output(d, _args, _files, combine=exec_wrap_combine_json_subdict, key="files", default_val={"files": {}})
...
addtask do_sca_phpsecaudit_report after do_sca_tracefiles before do_sca_deploy
