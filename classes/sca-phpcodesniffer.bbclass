                ...
                for m in v["messages"]:
                    try:
                        ...
                        if _suppress.Suppressed(g):
                            continue
                        if not sca_is_in_finding_scope(d, "phpcodesniffer", g.GetFormattedID()):
                            continue
...
do_sca_phpcodesniffer[depends] += "${@oe.utils.conditional('SCA_FORCE_RUN', '1', '${PN}:do_sca_do_force_meta_task', '', d)}"
do_sca_deploy_phpcodesniffer[depends] += "${@oe.utils.conditional('SCA_FORCE_RUN', '1', '${PN}:do_sca_do_force_meta_task', '', d)}"
