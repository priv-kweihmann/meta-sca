...
| Module          | Description                                           | Homepage                                                                   | Requires      | Run on image | Run on recipe | C | C\+\+ | Python | Shell | Javascript | PHP | Go | Images | Spelling | Metrics | Binaries | Packages | Other formats | Security scope | Functional scope | Style scope |
|-----------------|-------------------------------------------------------|----------------------------------------------------------------------------|---------------|--------------|---------------|---|-------|--------|-------|------------|-----|----|--------|----------|---------|----------|----------|---------------|----------------|------------------|-------------|
...
| cbmc            | C Bounded Model Checker                               | https://github\.com/diffblue/cbmc/                                         |               |              | x             | x |       |        |       |            |     |    |        |          |         |          |          |               |                | x                |             |
| checkbashisms   | Shell script linter                                   | https://manpages\.debian\.org/jessie/devscripts/checkbashisms\.1\.en\.html |               | x            | x             |   |       |        | x     |            |     |    |        |          |         |          |          |               |                | x                | x           |
| clang           | C/C\+\+ linter using LLVM                             | https://clang\.llvm\.org/extra/clang\-tidy/                                | meta\-clang   |              | x             | x | x     |        |       |            |     |    |        |          |         |          |          |               |                | x                |             |
...
| cspell          | Spelling linter                                       | https://github\.com/Jason3S/cspell                                         |               |              | x             |   |       |        |       |            |     |    |        | x        |         |          |          |               |                |                  | x           |
| cvecheck        | Check for unpatched CVEs                              | https://github\.com/clearlinux/cve\-check\-tool                            |               |              | x             |   |       |        |       |            |     |    |        |          |         |          | x        |               | x              |                  |             |
...
| htmlhint        | HTML linter                                           | https://github\.com/htmlhint/HTMLHint                                      |               | x            | x             |   |       |        |       |            |     |    |        |          |         |          |          | x             |                | x                |             |
| ikos            | C/C\+\+ linter using LLVM                             | https://github\.com/nasa\-sw\-vnv/ikos                                     | meta\-clang   |              | x             | x | x     |        |       |            |     |    |        |          |         |          |          |               |                | x                |             |
...
| npmaudit        | NPM package auditor                                   | https://docs\.npmjs\.com/cli/audit                                         |               |              | x             |   |       |        |       |            |     |    |        |          |         |          |          | x             | x              |                  |             |
| oclint          | C/C\+\+ linter using LLVM                             | https://github\.com/oclint/oclint                                          |               |              | x             | x | x     |        |       |            |     |    |        |          |         |          |          |               |                | x                |             |
| oelint          | Bitbake recipe linter                                 | https://github\.com/priv\-kweihmann/oelint\-adv                            |               | x            | x             |   |       |        |       |            |     |    |        |          |         |          |          | x             |                |                  | x           |
| phan            | PHP linter                                            | https://github\.com/phan/phan                                              | meta\-oe      |              | x             |   |       |        |       |            | x   |    |        |          |         |          |          |               |                | x                |             |
| phpcodefixer    | Find deprecated PHP functions                         | https://github\.com/wapmorgan/PhpCodeFixer                                 | meta\-oe      |              | x             |   |       |        |       |            | x   |    |        |          |         |          |          |               | x              |                  |             |
| phpstan         | PHP linter                                            | https://github\.com/phpstan/phpstan                                        | meta\-oe      |              | x             |   |       |        |       |            | x   |    |        |          |         |          |          |               |                | x                |             |
| progpilot       | PHP linter with security focus                        | https://github\.com/designsecurity/progpilot                               | meta\-oe      |              | x             |   |       |        |       |            | x   |    |        |          |         |          |          |               | x              |                  |             |
...
| pytype          | Python linter using type\-annotations                 | https://github\.com/google/pytype                                          |               |              | x             |   |       | x      |       |            |     |    |        |          |         |          |          |               |                | x                |             |
...
| retire          | Check for known vulnerabilities in javascript and NPM | https://retirejs\.github\.io/retire\.js/                                   |               |              | x             |   |       |        |       | x          |     |    |        |          |         |          | x        |               | x              |                  |             |
...
| sparse          | C linter                                              | https://sparse\.wiki\.kernel\.org/index\.php/Main\_Page                    |               |              | x             | x |       |        |       |            |     |    |        |          |         |          |          |               |                | x                |             |
| splint          | C linter                                              | https://github\.com/splintchecker/splint                                   |               |              | x             | x |       |        |       |            |     |    |        |          |         |          |          |               | x              | x                | x           |
| standard        | Javascript linter                                     | https://github\.com/standard/standard                                      |               | x            | x             |   |       |        |       | x          |     |    |        |          |         |          |          |               |                | x                | x           |
...
| wotan           | Typescript/javascript linter                          | https://github\.com/fimbullinter/wotan                                     |               | x            | x             |   |       |        |       | x          |     |    |        |          |         |          |          |               |                | x                | x           |
