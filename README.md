...
| Module          | Description                                   | Homepage                                                              | Requires      | Requires inet | Run on image | Run on recipe | Available in SDK | C   | C++ | Python | Shell | Javascript | PHP | Go  | Rust | Images | LUA | Spelling | Metrics | Binaries | Packages | Other formats | Security scope | Functional scope | Style scope |
| --------------- | --------------------------------------------- | --------------------------------------------------------------------- | ------------- | ------------- | ------------ | ------------- | ---------------- | --- | --- | ------ | ----- | ---------- | --- | --- | ---- | ------ | --- | -------- | ------- | -------- | -------- | ------------- | -------------- | ---------------- | ----------- |
...
| cargodeny       | Rust dependency linter                        | https://github.com/EmbarkStudios/cargo-deny                           |               |               |              | x             |                  | x   | x   |        |       |            |     |     | x    |        |     |          |         |          |          |               | x              |                  | x           |
...
| clippy          | lints to catch common mistakes in Rust        | https://github.com/rust-lang/rust-clippy                              |               |               |              | x             |                  | x   | x   |        |       |            |     |     | x    |        |     |          |         |          |          |               | x              | x                | x           |
