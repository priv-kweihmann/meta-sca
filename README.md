...
| cvecheck        | Check for unpatched CVEs                              | https://github.com/clearlinux/cve-check-tool                          |               | x             |              | x             |   |     |        |       |            |     |    |        |          |         |          | x        |               | x              |                  |             |
...
| oclint          | C/C++ linter using LLVM                               | https://github.com/oclint/oclint                                      | manual enable | x             |              | x             | x | x   |        |       |            |     |    |        |          |         |          |          |               |                | x                |             |
